...
function Sidebar() {
	...
	return (
		<div className={"hidden lg:flex max-lg:overflow-y-scroll overflow-x-hidden w-[300px] h-[90vh] border-r border-blue-400 fixed border-[2px] border-l-0 border-t-0 top-[10vh] left-0 border-b-0"}>
